...
export const InnerHouseCard = ({ house }: PropertyCardProps) => {
        ...
        <div className="pt-13 pl-20">
          ...
          <div className="flex items-center gap-4 mt-6">
            <img
              ...
              alt="user-photo"
              className="w-9 h-9 bg-[#C4C4C4] rounded-[50%]"
            />

            <div>
              <b>{house?.userResponse?.fullName}</b>
              <p className="text-[#828282]">{house?.userResponse?.email}</p>
            </div>
          </div>
