...
export const RAGIONS_IMAGES = [
  ...
  { id: 4, src: NarynImage, span: "col-span-2 row-span-2", alt: "naryn" },
  {
    id: 5,
    src: YssykKolImage,
    span: "col-span-1 row-span-1",
  ...
  { id: 6, src: TalasImage, span: "col-span-1 row-span-1", alt: "talas" },
  { id: 8, src: OshImage, span: "col-span-2 row-span-2", alt: "osh" },
  { id: 7, src: BishkekImage, span: "col-span-2 row-span-1", alt: "bishkek" },
];
